...
var TaskGroup, balUtilFlow, balUtilPaths, eachr, extendr, extractOptsAndCallback, pathUtil, safefs, typeChecker, _ref, _ref1,
...
balUtilPaths = {
  ...
  isIgnoredPath: function(path, opts) {
    var basename, ignorePath, result, _i, _len, _ref2;
    if (opts == null) {
      opts = {};
    }
    result = false;
  ...
  readPath: function(filePath, opts, next) {
    var data, err, http, req, requestOpts, tasks, zlib, _base, _ref2, _ref3;
    ...
    if (/^http/.test(filePath)) {
      ...
      req = http.request(requestOpts, function(res) {
        ...
        return res.on('end', function() {
          var locationHeader, _ref3;
          locationHeader = ((_ref3 = res.headers) != null ? _ref3.location : void 0) || null;
      ...
      req.setTimeout((_ref3 = opts.timeout) != null ? _ref3 : 10 * 1000);
